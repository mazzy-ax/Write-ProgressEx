...
GUID = '5f01cd33-a0b5-4725-99f4-af22a86621d9'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'Added event messages with #iterations, elapsed time, time of begin, time of end. SecondsRemaining fixed. See Cahngelog.md'
